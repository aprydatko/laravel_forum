                        ...
                        <tr v-for="complaint in complaints" class="text-gray-500">
                            ...
                            <td class="p-4">
                                <a @click.prevent="update(complaint)" href="#" class="block w-6 h-6 mx-auto">
                                    <svg :class="[complaint.is_solved ? 'stroke-green-700' :'stroke-red-700', 'size-6']" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
